...
export class Studio {
  ...
  public async activate(): Promise<void> {
    console.log('starting My extension');
    ...
    // register webview
    this.#panel = window.createWebviewPanel('studio', 'My', this.getWebviewOptions(extensionUri));
    ...
    console.log('extension can write user files in directory', appUserDirectory);
